                        ...
                        when (screen) {
                            ...
                            LauncherScreen.HOME -> {
                                HomeScreen(
                                    ...
                                    showAppLabels = uiState.preferences.showAppLabels,
                                    themedIcons = uiState.preferences.themedIcons,
                                    doubleTapToLock = uiState.preferences.doubleTapToLock,
                                    onLockDevice = { viewModel.navigateTo(LauncherScreen.LOCK) },
                            ...
                            LauncherScreen.DRAWER -> {
                                AppDrawerScreen(
                                    ...
                                    iconSizeDp = uiState.preferences.iconSizeDp,
                                    iconShape = uiState.preferences.iconShape,
                                    autoOpenKeyboard = uiState.preferences.autoOpenKeyboard,
                                    themedIcons = uiState.preferences.themedIcons,
                            ...
                            LauncherScreen.SETTINGS -> {
                                SettingsScreen(
                                    ...
                                    onClockStyleSelected = { style -> viewModel.setClockStyle(style) },
                                    onShowAppLabelsToggle = { enabled -> viewModel.setShowAppLabels(enabled) },
                                    onThemedIconsToggle = { enabled -> viewModel.setThemedIcons(enabled) },
                                    onAutoOpenKeyboardToggle = { enabled -> viewModel.setAutoOpenKeyboard(enabled) },
                                    onDoubleTapToLockToggle = { enabled -> viewModel.setDoubleTapToLock(enabled) },
